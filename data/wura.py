"""
Wura Dataset (for srs pretraining)
...
parser = argparse.ArgumentParser(description="Wura dataset preprocessing")
...
if __name__ == '__main__':
    ...
    for language in LANGUAGES.values():
            ...
            fw = load_dataset("castorini/wura", name=language, split=args.split, level="document")
            ...
            with mp.Pool(nprocs) as pool:
                ...
                for tokens in pool.imap(tokenize, fw, chunksize=16):
                    ...
                    language_tokens[language] = language_tokens.get(language, 0) + len(tokens)
